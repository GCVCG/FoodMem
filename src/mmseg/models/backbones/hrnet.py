...
from src.mmseg.ops import Upsample, resize
from src.mmseg.utils import get_root_logger
from src.mmseg.models.builder import BACKBONES
from src.mmseg.models.backbones.resnet import BasicBlock, Bottleneck
...
class HRNet(nn.Module):
    ...
    Example:
        >>> from src.mmseg.models.backbones import HRNet
        >>> import torch
        >>> extra = dict(
        >>>     stage1=dict(
        >>>         num_modules=1,
